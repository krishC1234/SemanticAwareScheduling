#!/usr/bin/env python3
"""DeepRecommender (Autoencoder for Collaborative Filtering) - batch=256, large params (~20M)"""
...
BATCH_SIZE = 256
HIDDEN_LAYERS = [512, 256, 128, 256, 512]  # Deeper encoder-decoder
EPOCHS = 3
NUM_SAMPLES = 10000
NUM_ITEMS = 20000
DROPOUT = 0.5
...
def main():
    ...
    if rank == 0:
        ...
        print(f"deeprec_256_large | GPUs:{ws} | Batch:{BATCH_SIZE} | Params:{pc:,}")
