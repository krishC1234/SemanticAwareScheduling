#!/usr/bin/env python3
"""DenseNet - batch=128, large params (~7M)"""
...
GROWTH_RATE = 32
BN_SIZE = 4
NUM_LAYERS = [6, 12, 24, 16]  # DenseNet-121 style
...
class DenseNet(nn.Module):
    def __init__(self, num_classes=10, num_layers=[6,12,24,16], bn_size=4, growth_rate=32):
        super().__init__()
...
def main():
    ...
    if rank == 0:
        ...
        print(f"densenet_128_large | GPUs:{ws} | Batch:{BATCH_SIZE} | Params:{pc:,}")
