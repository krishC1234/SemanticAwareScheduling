#!/usr/bin/env python3
"""MobileNetV3 Large - batch=32, small params (~2M)"""
...
class MobileNetV3Large(nn.Module):
    def __init__(self, num_classes=1000, width_mult=1.0, dropout=0.2):
        ...
        # MobileNetV3-Large config: [kernel, exp, out, SE, activation, stride]
        # activation: 0=ReLU, 1=Hardswish
        bneck_conf = [
            [3,  16,  16, False, 0, 1],
            [3,  64,  24, False, 0, 2],
            [3,  72,  24, False, 0, 1],
...
def main():
    ...
    if rank == 0:
        ...
        print(f"mobilenetv3_32_small | GPUs:{ws} | Batch:{BATCH_SIZE} | Params:{pc:,}")
