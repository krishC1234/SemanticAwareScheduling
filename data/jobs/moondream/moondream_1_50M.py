#!/usr/bin/env python3
"""Moondream (Lightweight VLM) - batch=1, ~50M params"""
...
class SigLIPEncoder(nn.Module):
    """SigLIP-style vision encoder (no CLS token)"""
    def __init__(self):
        super().__init__()
...
class VisionProjector(nn.Module):
    """MLP projector for vision features"""
    def __init__(self):
        super().__init__()
...
class PhiBlock(nn.Module):
    """Phi-style parallel attention + MLP block"""
    def __init__(self):
        super().__init__()
...
class Moondream(nn.Module):
    """Moondream: SigLIP encoder + Projector + Phi LM"""
    def __init__(self):
        super().__init__()
...
def main():
    ...
    if rank == 0:
        ...
        print(f"moondream_1_50M | GPUs:{ws} | Batch:{BATCH_SIZE} | Params:{pc:,}")
