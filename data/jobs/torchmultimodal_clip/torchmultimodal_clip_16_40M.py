#!/usr/bin/env python3
"""TorchMultimodal CLIP - batch=16, ~40M params"""
...
class ContrastiveLossWithTemperature(nn.Module):
    """Learnable temperature contrastive loss (torchmultimodal style)"""
...
def main():
    ...
    if rank == 0:
        ...
        print(f"torchmultimodal_clip_16_40M | GPUs:{ws} | Batch:{BATCH_SIZE} | Params:{pc:,}")
