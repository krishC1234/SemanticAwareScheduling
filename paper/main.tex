...
\begin{table*}[t]
\centering
\caption{Low contention: 3 jobs competing for 8 GPUs (0s inter-arrival delay)}
\label{tab:results_3jobs}
\begin{tabular}{lccccccc}
\toprule
Strategy & Makespan (s) & Avg JCT (s) & Jain's Fair. & Avg Slowdown & GPU Util. (\%) & GPU-min Wasted & Avg Eff. (\%) \\
\midrule
Greedy (8 GPU/job) & -- & -- & -- & -- & -- & -- & -- \\
Polite (1 GPU/job) & -- & -- & -- & -- & -- & -- & -- \\
FCFS-Split & -- & -- & -- & -- & -- & -- & -- \\
...
\begin{table*}[t]
\centering
\caption{Low-moderate contention: 5 jobs competing for 8 GPUs (0s inter-arrival delay)}
...
\begin{table*}[t]
\centering
\caption{Moderate contention: 12 jobs competing for 8 GPUs (0s inter-arrival delay)}
...
\begin{table*}[t]
\centering
\caption{High contention: 22 jobs competing for 8 GPUs (0s inter-arrival delay)}
