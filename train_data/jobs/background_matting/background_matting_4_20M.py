#!/usr/bin/env python3
"""Background Matting (GAN-based Video Matting) - batch=4, ~20M params"""
...
class ResBlock(nn.Module):
    def __init__(self, dim):
        ...
        self.conv = nn.Sequential(
            nn.Conv2d(dim, dim, 3, padding=1), nn.InstanceNorm2d(dim), nn.ReLU(True),
...
def main():
    ...
    if rank == 0:
        ...
        print(f"background_matting_4_20M | GPUs:{ws} | Batch:{BATCH_SIZE} | Params:{pc:,}")
