#!/usr/bin/env python3
"""DLRM (Deep Learning Recommendation Model) - batch=2048, small params (~5M)"""
...
EMBEDDING_TABLE_SIZES = [10000, 10000, 10000, 10000, 10000, 10000, 10000, 10000]
...
def main():
    ...
    if rank == 0:
        ...
        print(f"dlrm_2048_small | GPUs:{ws} | Batch:{BATCH_SIZE} | Params:{pc:,}")
