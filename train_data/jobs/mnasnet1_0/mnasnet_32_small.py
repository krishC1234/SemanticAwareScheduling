#!/usr/bin/env python3
"""MNASNet1.0 - batch=32, small params (~1M)"""
...
class MNASNet(nn.Module):
    def __init__(self, num_classes=1000, width_mult=1.0, dropout=0.2):
        ...
        # MNASNet block configs: (expansion, out_ch_idx, kernel, stride, repeats)
        configs = [
            (3, 1, 3, 2, 3),  # -> 24
            (3, 2, 5, 2, 3),  # -> 40
            (6, 3, 5, 2, 3),  # -> 80
...
def main():
    ...
    if rank == 0:
        ...
        print(f"mnasnet_32_small | GPUs:{ws} | Batch:{BATCH_SIZE} | Params:{pc:,}")
