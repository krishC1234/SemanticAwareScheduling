#!/usr/bin/env python3
"""UNet for Image Segmentation - batch=4, large params (~31M)"""
...
class UNet(nn.Module):
    ...
    def forward(self, x):
        x1, x2, x3, x4, x5 = self.inc(x), self.d1(self.inc(x)), None, None, None
...
def main():
    ...
    if rank == 0:
        ...
        print(f"unet_4_large | GPUs:{ws} | Batch:{BATCH_SIZE} | Params:{pc:,}")
