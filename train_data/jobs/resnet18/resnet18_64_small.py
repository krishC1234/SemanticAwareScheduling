#!/usr/bin/env python3
"""ResNet18 - batch=64, small params (~5M with width=0.5)"""
...
def ResNet18(num_classes=1000, width_mult=1.0):
    return ResNet(BasicBlock, [2, 2, 2, 2], num_classes, width_mult)
