#!/usr/bin/env python3
"""ResNet50 - batch=32, small params (~12M with width=0.5)"""
...
def ResNet50(num_classes=1000, width_mult=1.0):
    return ResNet(Bottleneck, [3, 4, 6, 3], num_classes, width_mult)
